                                ...
                                <div class="card">
                                    <div class="seo-fact sbg2">
                                        ...
                                        ?>
                                            ...
                                            <h2><?php echo "{$row_ur['total_user']}"; ?></h2>
                                        </div>
                                    ...
                                    <div class="seo-fact sbg2">
                                        <div class="p-4 d-flex justify-content-between align-items-center">
                                         ...
                                         $quert_vr= mysqli_query($connection, "select count(*) total_vendor FROM `tbl_vendormaster`");
                                            ...
                                            ?>
                                            <div class="seofct-icon"><i class="ti-bag"></i> vendor</div>
                                            <h2><?php echo "{$row_vr['total_vendor']}"; ?></h2>
                                        </div>
                            ...
                            <div class="col-md-3 mt-md-4 mb-3">
                                <div class="card">
                                    <div class="seo-fact sbg2">
                                        ...
                                        ?>
                                            <div class="seofct-icon"><i class="ti-list"></i>category</div>
                                            <h2><?php echo "{$row_cr['total_cat']}"; ?></h2>
                                        </div>
                            ...
                            <div class="col-md-3 mt-md-4 mb-3">
                                <div class="card">
                                    <div class="seo-fact sbg2">
                                        ...
                                        ?>
                                            <div class="seofct-icon"><i class="ti-home"></i>Area</div>
                                            <h2><?php echo "{$row_ar['total_ar']}"; ?></h2>
                                        </div>
