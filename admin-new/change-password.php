                    ...
                    <form method="post">
                        ...
                        <div class="login-form-body">
                            <div class="form-gp">
                                ...
                                <input type="password" name="opass" class="form-control" placeholder="" required="true"/>

                                <i class="ti-lock"></i>
                            </div>
                            <div class="form-gp">
                                <label for="exampleInputEmail1">New password</label>
                                <input type="password" name="npass" class="form-control" placeholder="" required="true"/>

                                <i class="ti-lock"></i>
                            </div>
                            <div class="form-gp">
                                <label for="exampleInputEmail1">Confirm password</label>
                                <input type="password" name="cpass" class="form-control" placeholder="" required="true"/>
