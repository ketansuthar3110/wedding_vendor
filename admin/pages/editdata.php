...
if($_POST)
{
   ...
   $mono = $_POST['txt5'];
   $address = $_POST['txt6'];
   $update=mysqli_query($connection,"update tbl_user set user_name = '{$name}',user_gender = '{$gender}',user_email = '{$email}',user_pass = '{$pass}',user_mobile = '{$mono}',user_address = '{$address}' where user_id = '{$editid}'") or die (mysqli_error($connection));
if($update)
{
                                    ...
                                    <div class="card-body">
                                        <form method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="inputPassword" type="password" name="txt4"  value= "<?php echo $selectrow['user_pass']; ?>" placeholder="Password" class="form-control">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <button type="button" class="btn btn-default"onclick="window.location = 'general-table.php'">View Record</button> 
                                        </div>
                                        </form>
                                    </div>
