...
$msg = "";
    $editid = $_GET['uid'];
        $up = mysqli_query($connection,"select * from tbl_review where review_id = '{$editid}'") or die (mysqli_error($connection));
...
if ($_POST) {
   ...
   $update=mysqli_query($connection,"update tbl_review set review_date='{$date}',review_details='{$details}', vendor_id = '{$vidid}',user_id = '{$uid}' where review_id = '{$editid}'") or die (mysqli_error($connection));
if($update)
{
...
<head>
    ...
    <title>Wedding Vendor edit-review</title>
    <!-- Bootstrap CSS -->
                                    ...
                                    <div class="card-body">
                                        <form method="post">
                                            <div class="form-group">
                                                ...
                                                <input id="inputText3" type="date"  value= "<?php echo $selectrow['review_date']; ?>" class="form-control" name="txt1">
                                            </div>
                                            
                                            <div class="form-group">
                                                <label for="exampleFormControlTextarea1">Review Details</label>
                                                <textarea class="form-control" id="exampleFormControlTextarea1"   name="txt2" rows="3"><?php echo $selectrow['review_details']; ?></textarea>
                                            </div>
                                            ...
                                            <button type="button" class="btn btn-primary btn-sm"onclick="window.location = 'view-review.php'">View Record</button> 
                                        </div>                                        </form>
                                    </div>
