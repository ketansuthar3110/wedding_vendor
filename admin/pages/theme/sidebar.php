                                    ...
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            ...
                                            <div id="submenu-1-2" class="collapse submenu" style="">
                                                <ul class="nav flex-column">
                                                    <li class="nav-item">
                                                        <a class="nav-link" href="master.php">E Commerce Dashboard</a>
                                                    </li>
                                                    <li class="nav-item">
                                ...
                                <div id="submenu-4" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                       <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="add-area.php">Area</a>
                                        </li>
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="add-booking.php">Booking</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="add-review.php">Review</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            <li class="nav-item">
                                ...
                                <div id="submenu-5" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="view-area.php">Area</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="view-vendor.php">Vendor</a>
                                        </li>
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="view-review.php">Review</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
