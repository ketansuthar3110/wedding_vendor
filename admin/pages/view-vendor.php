                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                         ...
                         Record Deleted
                                        ...
                                        while ($data = mysqli_fetch_array($join)) {
                                            ...
                                            echo "<td><img style = 'width:30px;'src='{$data['vendor_photo']}'</td>";
                                            echo "<td>{$data['vendor_price']}</td>";
                                            echo "<td>{$data['vendor_mobileno']}</td>";
                                            echo "<td>{$data['vendor_email']}</td>";
                                            echo "<td>{$data['vendor_password']}</td>";
                                            echo "<td><button><a href='edit-vendor.php?eid=$data[0]'>edit</a> </button>&<button> <a href='view-vendor.php?did=$data[0]'>Delete</a></button></td>";
                                            echo "</tr>";
                                        }
                                        ?>
                                    </table>
