                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="page-header" id="top">
                                    <h2 class="pageheader-title">Admin Form</h2>
                                    ...
                                    <div class="card-body">
                                        <form method="post"id="myform">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="inputEmail" type="email" name="txt2" placeholder="Enter email address" class="form-control" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="inputPassword">Admin Password</label>
                                                <input id="inputPassword" type="password" name="txt3" placeholder="Enter password" class="form-control" required>
                                            </div>
                                            <div class="form-group"> 
