...
<body>
    ...
    <div class="wide-post-image"> <img src="images/hero-image-3.jpg" alt="" class="img-responsive"> </div>
                        ...
                        <div class="col-md-12 post-author">
                            ...
                            <div class="row">
                                ...
                                <div class="author-pic col-md-3">
                                    <a href="#"><img src="images/founder.jpg" class="img-responsive img-circle" alt=""></a>
                                </div>
                                <div class="author-info col-md-9">
                                    ...
                                    <!-- /.author name -->
                                    <p>Lorem Ipsum is that it has a normal distribution of letters, as possible opposed to use usingmaking it look web page is editors now use.</p>
                                                    ...
                                                    <div class="panel panel-default arrow left">
                                                        <div class="panel-body">
                                                            ...
                                                            <div class="review-post">
                                                                ...
                                                                <a href="#" class="btn btn-primary btn-sm"> Reply</a> </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="col-md-12 leave-comments">
                            ...
                            <form class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <button class="btn btn-primary btn-lg">Submit A Comments</button>
                                    </div>
                                </div>
                            </form>
                        </div>
