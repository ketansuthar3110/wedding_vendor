            ...
            <div class="row">
                <div class="col-md-12 dashboard-nav">
                    <ul class="nav nav-pills nav-justified">
                        ...
                        <li><a href="couple-wishlist.php"><i class="fa fa-heart db-icon"></i>My Wishlist </a></li>
                        ...
                        <li class="active"><a href="couple-profile.php"><i class="fa fa-user db-icon"></i>My Profile</a></li>
                    </ul>
                </div>
            </div>
        </div>
