            ...
            <div class="row">
                <div class="col-md-offset-2 col-md-8">
                    <div class="page-header text-center">
                        <div class="icon-circle"> <i class="icon icon-size-60 icon-wedding-cake-1 icon-white"></i> </div>
                        <h1>Cake Listing Sidebar</h1>
                        <p>Cake Listing Sidebar for multiple use for vendor.</p>
                    </div>
                </div>
            </div>
        </div>
