  ...
  <div class="container">
    <div class="row">
      <div class="col-md-3 logo">
        <div class="navbar-brand"> <a href="index.php"><img src="images/logo.png" alt="Wedding Vendors" class="img-responsive"></a></div>
      </div>
      <div class="col-md-9">
    ...
    <div class="row">
      <div class="col-md-12 dashboard-nav">
        <ul class="nav nav-pills nav-justified">
          ...
          <li><a href="dashboard-my-listing.php"><i class="fa fa-list db-icon"></i>My Listing </a></li>
          <li class="active"><a href="dashboard-add-listing.php"><i class="fa fa-plus-square db-icon"></i>Add listing</a></li>
            ...
            <div class="bg-white pinside40 mb30">
              <form>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <div class="">
                        <textarea class="form-control" id="Address" name="Address" rows="6">Address</textarea>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="row">
                  ...
                  <div class="col-md-6"> 
                    ...
                    <div class="form-group">
                      ...
                      <div class="">
                        <input id="state" name="State" type="text" placeholder="Title" class="form-control input-md" required="">
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-12">
                    <textarea class="form-control" id="description" name="description" rows="6">Descriptions</textarea>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-4"> 
                  ...
                  <div class="col-md-4"> 
                    ...
                    <div class="form-group">
                      ...
                      <div class=" ">
                        <select id="seatcapacity" name="seatcapacity" class="form-control">
                ...
                <div class="row">
                  <div class="col-md-6"> 
                    ...
                    <div class="form-group">
                      ...
                      <div class="">
                        <input id="state" name="State" type="text" placeholder="Latitude" class="form-control input-md" required="">
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6"> 
