            ...
            <div class="row">
                <div class="col-md-12 dashboard-nav">
                    <ul class="nav nav-pills nav-justified">
                        <li><a href="couple-dashboard.php"><i class="fa fa-dashboard db-icon"></i>My Dashboard</a></li>
                        <li class="active"><a href="couple-wishlist.php"><i class="fa fa-heart db-icon"></i>My Wishlist </a></li>
                        <li><a href="couple-checklist.php"><i class="fa fa-list db-icon"></i>My Checklist</a></li>
                        <li><a href="couple-budget.php"><i class="fa fa-calculator db-icon"></i>My Budget</a></li>
                        <li><a href="couple-guestlist.php"><i class="fa fa-users db-icon"></i>My Guest List</a></li>
                        <li><a href="couple-profile.php"><i class="fa fa-user db-icon"></i>My Profile</a></li>
                    </ul>
                </div>
            </div>
        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="vendor-list-block mb30">
                                    ...
                                    <div class="vendor-img">
                                        <a href="#"><img src="images/vendor-new-1.jpg" alt="wedding venue" class="img-responsive"></a>
                            ...
                            <div class="col-md-4">
                                <div class="vendor-list-block mb30">
                                    <!-- vendor list block -->
                                    <div class="vendor-img">
                                        <a href="#"><img src="images/vendor-new-2.jpg" alt="wedding venue" class="img-responsive"></a>
                            ...
                            <div class="col-md-4">
                                <div class="vendor-list-block mb30">
                                    <!-- vendor list block -->
                                    <div class="vendor-img">
                                        <a href="#"><img src="images/vendor-new-3.jpg" alt="wedding venue" class="img-responsive"></a>
                            ...
                            <div class="col-md-4">
                                <div class="vendor-list-block mb30">
                                    <!-- vendor list block -->
                                    <div class="vendor-img">
                                        <a href="#"><img src="images/vendor-new-4.jpg" alt="wedding venue" class="img-responsive"></a>
