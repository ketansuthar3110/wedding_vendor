...
<body>
    ...
    <div class="splash-container">
        <div class="card">
            <div class="card-header text-center"><img class="logo-img" src="../assets/images/logo.jpg" alt="logo"><span class="splash-description">Please enter your user information.</span></div>
            <div class="card-body">
                <form method="post" id="myform">
                    ...
                    <div class="form-group">
                     ...
                     <button id="submit" name="submit" class="btn btn-primary btn-lg">Mail Send</button>
                </form>
            </div>
