...
define(PROJECT_NAMESPACE . "PROJECT_NAME", "vendor_report"); // Project name
define(PROJECT_NAMESPACE . "CONFIG_FILE_FOLDER", PROJECT_NAME); // Config file name
define(PROJECT_NAMESPACE . "RANDOM_KEY", '1nVCeAfRU9q5R9JL'); // Random key for encryption
define(PROJECT_NAMESPACE . "ENCRYPTION_KEY", ''); // Encryption key for data protection
define(PROJECT_NAMESPACE . "PROJECT_STYLESHEET_FILENAME", "phprptcss/vendor_report.css"); // Project stylesheet file name
...
$PROJECT_ID = "{4A46E034-607B-45F3-9359-2514C22D43B7}"; // Project ID (GUID)
$RELATED_PROJECT_ID = "";
...
$CONNECTIONS["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "db_wedding", "qs" => "`", "qe" => "`");
...
// Validate option
define(PROJECT_NAMESPACE . "CLIENT_VALIDATE", FALSE);
