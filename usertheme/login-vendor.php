...
if ($_POST) {
    ...
    $select = mysqli_query($connection, "select * from tbl_vendormaster where vendor_email = '{$email}' and vendor_password = '{$pass}'") or die(mysqli_error($connection));
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8">
                        <ol class="breadcrumb">
                            <li><a href="#">Home</a></li>
                            <li class="active">Login Vendor</li>
                        </ol>
                    </div>
                </div>
            </div>
                        ...
                        <div class="well-box">
                            ...
                            <form method="post" id="myform">
                                ...
                                <div class="form-group">
                                    ...
                                    <a href="forget-password-vendor.php" class="pull-right"> <small>Forgot Password ?</small></a>
                                    <div class="form-group">
                                        <label class="control-label" for="user">Don't have an account?<a href="signup-vendor.php"><b>Register</b></a></label>
